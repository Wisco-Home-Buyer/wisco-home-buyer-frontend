...
export function Step3Details({ formData, updateFormData, onNext, onBack }: Step3DetailsProps) {
  ...
  const handleNumberChange = (field: keyof Step3DetailsProps["formData"], val: string) => {
    if (val === "") {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          <label htmlFor="bedrooms" className="text-xs font-bold text-[#0B2545]/80 uppercase tracking-wide">
            Bedrooms
          </label>
          <input
            id="bedrooms"
        ...
        {/* Bathrooms */}
        <div className="space-y-1.5">
          <label htmlFor="bathrooms" className="text-xs font-bold text-[#0B2545]/80 uppercase tracking-wide">
            Bathrooms
          </label>
          <input
            id="bathrooms"
        ...
        {/* Square Feet */}
        <div className="space-y-1.5">
          <label htmlFor="squareFeet" className="text-xs font-bold text-[#0B2545]/80 uppercase tracking-wide">
            Square Feet
          </label>
          <input
            id="squareFeet"
        ...
        {/* Year Built */}
        <div className="space-y-1.5">
          <label htmlFor="yearBuilt" className="text-xs font-bold text-[#0B2545]/80 uppercase tracking-wide">
            Year Built
          </label>
          <input
            id="yearBuilt"
